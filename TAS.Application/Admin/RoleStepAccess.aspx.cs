...
public partial class Admin_RoleStepAccess : AuthenticatedPageClass
{
    ...
    void FillGrid()
    {
        ...
        {
            DataTable dt = new DataTable();
            W.GetRoleStatuses(DDLRoles.SelectedValue, ref dt);
    ...
    protected void GVRolesPermissions_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        try
        {
            ...
            if (e.CommandName == "GrantPermission")
            {
                ...
                W.RoleAccessToStatusesToggle(DDLRoles.SelectedValue, StatusID);
                FillGrid();
            }
        }
        catch (Exception ex)
    ...
    protected void GVRolesPermissions_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                ibConfirm.CommandArgument = DataBinder.Eval(e.Row.DataItem, "StatusID").ToString();
            }
