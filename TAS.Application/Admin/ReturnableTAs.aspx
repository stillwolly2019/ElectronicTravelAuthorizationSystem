<%@ Page Title="Returnable TAs" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReturnableTAs.aspx.cs" Inherits="Admin_ReturnableTAs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header">Returnable TA Status Settings</h4>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <asp:GridView ID="GVReturnableStatuses" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False"
                                OnRowCommand="GVReturnableStatuses_RowCommand"
                                DataKeyNames="LookupsID" OnRowDataBound="GVReturnableStatuses_RowDataBound" EmptyDataText="No records to display">
                                <Columns>
    ...
    <script>
        $(document).ready(function () {
            $('#ContentPlaceHolder1_GVReturnableStatuses').DataTable({
                "ordering": false,
