<%@ Page Title="Transfer TA" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MapAcomodationLocations.aspx.cs" Inherits="TravelAuthorization_MapAcomodationLocations" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
          function RedirectHome() {
        window.parent.location.href = 'MapAcomodationLocations.aspx';
    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header"><font color="#124a92"> <b>Accomodation Location Mapping:- </b> Travel Authorizations  pending mapping</font></h4>
                        ...
                        <div class="col-lg-12">
                            <div class="dataTable_wrapper">
                                ...
                                <asp:GridView ID="GVMyTAs" Width="100%" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False"
                                    OnRowCommand="GVMyTAs_RowCommand" DataKeyNames="TravelAuthorizationID,StatusCode,ActionNeeded,TravelAuthorizationNumber,CreatorID,TravelersName,AccommodationDetails,AccommodationLocationID" OnRowDeleting="GVMyTAs_RowDeleting"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Wrap="false" HeaderText="Travel Authorization Number" HeaderStyle-CssClass="text-center" ItemStyle-Width="220px">
                                            <ItemTemplate>
                                               ...
                                               <asp:LinkButton ID="ibDelete" runat="server" CommandName="MapTA" ToolTip="Click to Map"  CommandArgument='<%# Container.DisplayIndex %>' Text='<%# Eval("TravelAuthorizationNumber") %>'><li class="fa fa-search-plus"></li> Map TA </asp:LinkButton>
                                                 </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:BoundField DataField="AccommodationDetails" HeaderText="Accommodation Details " />
                                        <asp:BoundField DataField="AccommodationLocationName" HeaderText="Mapped Location " />
        ...
        <%--<div class="modal-dialog" style="width: 90%">--%>
            <div class="modal-content" style="width: 100%;">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Accomodation Location Mapping:  <b><asp:Label ID="lblFullName" runat="server"></asp:Label></b></h4>
                </div>
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="DDLLocations" runat="server" CssClass="form-control Req1" AutoPostBack="True" DataTextField="LocationName" DataValueField="LocationID"></asp:DropDownList>
                                            </div>
                                        </div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <asp:HiddenField ID="hdnAccommodationLocationID" runat="server" Value="" />
                                        ...
                                        <asp:GridView ID="GVTravelAuthorization" runat="server" CssClass="table table-striped table-bordered table-hover"
                                            ...
                                            DataKeyNames="TravelAuthorizationID,TravelAuthorizationNumber,TravellorID,TravellorFullName,CreatorID,CreatorFullName,PurposeOfTravel"
