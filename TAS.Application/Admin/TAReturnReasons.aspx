<%@ Page Title="Return reason mapping" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TAReturnReasons.aspx.cs" Inherits="Admin_TAReturnReasons" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header" style="color:darkblue"><b>TA Return reasons by Status Codes</b></h4>
