...
<%@ Page Title="Manage Users" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MultipleDelegation.aspx.cs" Inherits="Admin_MultipleDelegation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header">Multiple delegation setup</h4>
            ...
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                            <div class="dataTable_wrapper">
                                ...
                                <asp:GridView ID="GVUsersDelegation" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" OnRowCommand="GVUsersDelegation_RowCommand"
                                    DataKeyNames="UserId,MaximumDelegations,DisplayName"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="MaximumDelegations" HeaderText="Maximum delegations" ControlStyle-CssClass="center-block" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <asp:LinkButton ID="LnkAddNewDelegation" CssClass="form-control btn btn-outline btn-primary" runat="server" Font-Size="12px" OnClick="LnkAddNewDelegation_Click"><li class="fa fa-save"></li>&nbsp;Add new record</asp:LinkButton>
                        </div>
                    </div>
                </div>
            </div>
                                            ...
                                            <td style="vertical-align: top; padding: 20px; width: 90%">
                                                <table>
                                                     ...
                                                     <tr>
                                                       ...
                                                       <tr>
                                                        <td class="tdLabel">Maximum delegations</td>
                                                        <td class="tdField">
                                                            <asp:TextBox ID="txtMaximumDelegations" CssClass="form-control Req" runat="server"></asp:TextBox>
                                                        </td>
                                                    </tr>
