<%@ Page Title="Radio Operator Location Access" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RadioOperatorAccesses.aspx.cs" Inherits="Admin_RadioOperatorAccesses" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header">Radio Operators</h4>
                        ...
                        <div class="col-lg-12">
                            <div class="dataTable_wrapper">
                                ...
                                <asp:GridView ID="GVUsers" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" OnRowCommand="GVUsers_RowCommand"
                                    DataKeyNames="UserID,UserName,Email,FirstName,LastName,FullName,IsManager,Active,PRISM_Number"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Action" HeaderStyle-CssClass="text-center">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="ibUserRoles" CausesValidation="False" CommandName="ManageRolesAccesses" ToolTip="Manage Locations Access" CommandArgument='<%# Container.DisplayIndex %>'  runat="server"> <li class="fa fa-gear"> </li> Locations Access Details</asp:LinkButton>
                                                </div>
        ...
        <div class="modal-dialog" style="width: 50%">
            <div class="modal-content" style="width: 100%;">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Radio Operator access Information:  <b><asp:Label ID="lblFullName" runat="server"></asp:Label></b></h4>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <asp:GridView ID="GVUserRoleAccess" runat="server" CssClass="table table-striped table-bordered table-hover"
                                            ...
                                            DataKeyNames="ID,UserID,LocationID"
