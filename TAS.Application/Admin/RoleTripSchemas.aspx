<%@ Page Title="Roles Trip Schemas" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RoleTripSchemas.aspx.cs" Inherits="Admin_RoleTripSchemas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header" style="color:darkblue"><b>Role access to Trip Schemas</b></h4>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <asp:GridView ID="GVRolesPermissions" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False"
                                ...
                                DataKeyNames="LookupsID,Description" OnRowDeleting="GVRolesPermissions_RowDeleting" OnRowDataBound="GVRolesPermissions_RowDataBound" EmptyDataText="No records to display">
                                <Columns>
                                    
                                    <asp:TemplateField HeaderText="Trip Description">
                                        <ItemTemplate>
                                            <asp:Label runat="server" Text='<%# Bind("Description") %>' ID="Label2"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                     <%--<asp:BoundField DataField="Code" HeaderText="Status Code" HeaderStyle-CssClass="text-center">
                            <ItemStyle CssClass="text-center" />
                            </asp:BoundField>--%>

                                    <asp:TemplateField HeaderText="Allow Access to this Trip Schema" ShowHeader="False" HeaderStyle-CssClass="text-center">
                                        <ItemTemplate>
