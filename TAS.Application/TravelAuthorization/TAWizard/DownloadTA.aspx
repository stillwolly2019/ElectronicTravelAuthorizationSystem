<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DownloadTA.aspx.cs" Inherits="TravelAuthorization_TAWizard_DownloadTA" %>
            ...
            <ContentTemplate>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title"> Step 5 - Print & Download TA</h4>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label></label>
                                    <asp:Button ID="btnNext" runat="server" CssClass="form-control btn-primary" Text="Submit & continue" OnClick="btnNext_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
