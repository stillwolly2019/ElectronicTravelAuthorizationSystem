...
public partial class TravelAuthorization_TAWizard_DownloadTEC : AuthenticatedPageClass
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            try
            {
                ...
                lnk = (LinkButton)WizardHeader.FindControl("lbStep9");
    ...
    protected void ViewTAForm()
    {
        ...
        sr.ReportPath = System.Configuration.ConfigurationManager.AppSettings["ReportsPath"].ToString() + "/Travel Expense Claim";
        ...
        Microsoft.Reporting.WinForms.ReportParameter p = new Microsoft.Reporting.WinForms.ReportParameter("TravelAuthorizationNumber", Decrypt(Request["TANO"]));
