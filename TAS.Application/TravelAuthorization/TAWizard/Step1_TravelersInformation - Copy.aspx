                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <asp:Panel ID="Panel2" runat="server">
                                <div class="col-lg-3">
                                    <label><b>Domestic/International:</b></label>
                                     <asp:DropDownList ID="ddlFlightCategory" AutoPostBack="true" runat="server" Enabled="false" DataTextField="Description" DataValueField="LookupsID" CssClass="form-control" />
                                </div>
                            ...
                            <div class="row" style="width: 99.9%;">
                                <div class="col-lg-12">
                                    <table style="width:100%;">
                                        <tr style="width:100%;padding-top:10px;padding-bottom:10px;">

                                            <td class="tdField col-lg-6">
                                                <b>Domestic/International:</b>
                                            </td>

                                            <td class="tdField col-lg-6">
                                                <b>Carrier:</b>
                                                <asp:DropDownList ID="ddlCarrierCode" AutoPostBack="true" OnSelectedIndexChanged="ddlCarrierCode_SelectedIndexChanged" runat="server" Enabled="false" DataTextField="Description" DataValueField="LookupsID" CssClass="form-control Req" />
                                            </td>

                                            <td class="tdField col-lg-6">
                                                <b>Flight/Reference No:</b>
                                                <asp:TextBox ID="txtFlightRefNumber" placeholder="Flight Ref No(KQ350)" runat="server" Enabled="false" CssClass="form-control Req"></asp:TextBox>
                                            </td>
                                        </tr>

                                        <tr id="trCargo" visible="false" runat="server" style="padding-top:10px;padding-bottom:10px;">

                                            <td class="tdField col-lg-12" colspan="2">
                                                <b>Extra Cargo:</b><asp:DropDownList ID="ddlExtraCargoCode" ToolTip="Extra luggage for domestic flights" runat="server" DataTextField="Description" DataValueField="LookupsID" CssClass="form-control Req" />
                                            </td>
                                        </tr>

                                        <tr style="padding-top:10px;padding-bottom:10px;">
                                            <td class="tdField col-lg-6">
                                                <b>ETD / ETA</b><asp:DropDownList ID="ddlETDETACode" ToolTip="Departure time for outbound flights and Arrival time for inbound flights" runat="server" DataTextField="Description" DataValueField="LookupsID" CssClass="form-control Req" />
                                            </td>
                                            <td class="tdField col-lg-6">
                                                <b>ETD / ETA Pick-up:</b><asp:DropDownList ID="ddlETDETAPickup" runat="server" DataTextField="Description" DataValueField="LookupsID" CssClass="form-control Req" />
                                            </td>
                                        </tr>
                                        ...
                                        <tr style="padding-top:10px;padding-bottom:10px;">
                                            <td class="tdField col-lg-6">
                                                <b>Pick-up / Drop-off Location:</b><asp:DropDownList ID="ddlPickupLocation" ToolTip="Pick-up / Drop-off Location: e.g.(Hotel, NGH, OGH, office, GGH)"
                                                    runat="server" DataTextField="Description" DataValueField="LookupsID" CssClass="form-control Req" />
                                            </td>
                                            <td class="tdField col-lg-6">
                                                <b>Booking/Travel Status:</b><asp:DropDownList ID="ddlBookingStatus" runat="server" DataTextField="Description" DataValueField="LookupsID" ToolTip="(Use Inbound and Outbound for International flights)" CssClass="form-control Req" />
                                            </td>
                                        </tr>
                                        ...
                                        <tr style="padding-top:10px;padding-bottom:10px;">
                                            <td class="tdField col-lg-12" style="float: right" colspan="2">
