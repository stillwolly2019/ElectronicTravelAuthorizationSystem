<%@ Page Title="My Travel Authorizations" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="StaffTravelAuthorizations.aspx.cs" Inherits="TravelAuthorization_StaffTravelAuthorizations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header">My Travel Authorizations</h4>
                        ...
                        <div class="col-lg-12">
                            <div class="dataTable_wrapper">
                                ...
                                <asp:GridView ID="GVMyTAs" Width="100%" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False"
                                    OnRowCommand="GVMyTAs_RowCommand" DataKeyNames="TravelAuthorizationID,StatusCode,TravelAuthorizationNumber" OnRowDeleting="GVMyTAs_RowDeleting"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="CONCATLegs"  HeaderText="Travel Itinerary" />
                                        ...
                                        <asp:TemplateField ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="ibDeleteTA" runat="server" CommandName="Delete" ToolTip="Delete" CommandArgument='<%# Container.DisplayIndex %>' OnClientClick="return ConfirmDelete();"><li class="fa fa-times" ></li> Delete TA</asp:LinkButton>
