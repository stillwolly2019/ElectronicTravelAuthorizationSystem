<%@ Page Title="Manage Lookups Groups" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ManageLookupsGroups.aspx.cs" Inherits="Lookups_ManageLookupsGroups" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header">Manage Lookup Groups</h4>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <asp:GridView ID="gvLookupsGroup" runat="server" CssClass="table table-striped table-bordered table-hover"
                                AutoGenerateColumns="False"
                                OnRowCommand="gvLookupsGroup_RowCommand"
                                DataKeyNames="LookupGroupID"
                                OnRowDeleting="gvLookupsGroup_RowDeleting"
                                OnRowDataBound="gvLookupsGroup_RowDataBound" EmptyDataText="No records to display">
                                <Columns>
                                    <asp:BoundField DataField="LookupGroup" HeaderText="Lookup Group Name" />
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                    ...
                                    <table>
                                        <tr>
                                            <td style="vertical-align: top; padding: 20px; width: 90%">
                                                <table>
                                                    <tr>
                                                        <td class="tdLabel">Lookup Group Name</td>
                                                        <td class="tdField">
    ...
    <script>
        $(document).ready(function () {
            if ($(".GVCount").text() != "0") {
                $('#ContentPlaceHolder1_gvLookupsGroup').DataTable({
