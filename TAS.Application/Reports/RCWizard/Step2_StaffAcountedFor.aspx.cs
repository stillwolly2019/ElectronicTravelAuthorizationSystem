...
public partial class Reports_Step2_DailyRadioCheck : AuthenticatedPageClass
{
    //RadioCheckBusiness.Lookups l = new RadioCheckBusiness.Lookups();
    ...
    void FillGrid()
    {
        try
        {
            ...
            R.GetStaffAccountedFor(ref dt, RadioCheckID, LocationID);
