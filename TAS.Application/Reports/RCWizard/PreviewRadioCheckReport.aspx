<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreviewRadioCheckReport.aspx.cs" Inherits="Reports_RCWizard_PreviewRadioCheckReport" %>
                    ...
                    <asp:Label ID="lblmsg" runat="server" Text=""></asp:Label>
                        ...
                        <div class="row">
                            ...
                            <label>Location</label>
                                <asp:DropDownList ID="ddlLocationsName" CssClass="form-control" DataTextField="LocationName" DataValueField="LocationID" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlLocationsName_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                            ...
                            <div class="col-lg-2">
                            <label>Number of Times Unaccounted</label>
