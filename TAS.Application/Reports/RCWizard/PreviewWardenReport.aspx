<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreviewWardenReport.aspx.cs" Inherits="Reports_RCWizard_PreviewWardenReport" %>
                    ...
                    <asp:Label ID="lblmsg" runat="server" Text=""></asp:Label>
                        ...
                        <div class="row">
                            ...
                            <label>Location</label>
                                <asp:DropDownList ID="DDLLocation" CssClass="form-control" DataTextField="LocationName" DataValueField="LocationID" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DDLLocation_SelectedIndexChanged"></asp:DropDownList>
                            </div>

                                <div class="col-lg-3">
                            <label>Zone</label>
                                <asp:DropDownList ID="DDLZone" CssClass="form-control" DataTextField="ZoneName" DataValueField="ZoneID" runat="server" AutoPostBack="True"></asp:DropDownList>
                            </div>

                                <div class="col-lg-1">
                                <label>&nbsp;</label>
                                    <asp:Button ID="btnSearchReport" OnClick="btnSearchReport_Click"  runat="server" CssClass="form-control btn-primary" Text="Search" Font-Size="14px" Width="100px" OnClientClick="return SaveValidation();" />
                                </div>

                                <div class="col-lg-2">
                                <label>&nbsp;</label>
                                    <asp:Button ID="btnClearReport" OnClick="btnClearReport_Click"  runat="server" CssClass="form-control btn-primary" Text="Clear" Font-Size="14px" Width="100px" OnClientClick="return SaveValidation();" />
                                </div>
