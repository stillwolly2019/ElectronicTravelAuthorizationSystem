<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Dispatch.aspx.cs" Inherits="Reports_Dispatch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanelWizard" runat="server">
        <ContentTemplate>
            <div class="row">
                <div class="col-lg-12">
                    <iframe id="IFrameReport" scrolling="no" style="border: none; width: 100%; height: 1250px; background-color: #fff" runat="server"></iframe>
                </div>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
