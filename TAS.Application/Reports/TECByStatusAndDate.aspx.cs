...
public partial class Reports_TECByStatusAndDate : AuthenticatedPageClass
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            RV.ServerReport.ReportPath = System.Configuration.ConfigurationManager.AppSettings["ReportsPath"].ToString() + "/TECsByStatusAndDates";
