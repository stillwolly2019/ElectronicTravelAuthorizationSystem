<%@ Page Language="C#" AutoEventWireup="true" CodeFile="3_AbsenceDetails.aspx.cs" Inherits="RadioCheck_NOAWizard_3_AbsenceDetails" %>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">Step 3 - Leave Break down</h4>
                            </div>
                            <div class="panel-body">
                                <asp:Panel ID="pnlContent" runat="server">
                                    ...
                                    <table>
                                        <tr>
                                            <td class="tdField">
                                                <asp:DropDownList ID="ddlLeaveCategory" runat="server" DataTextField="Description" DataValueField="LookupsID" CssClass="form-control ReqG1" Width="220px" />
                                            </td>
                                            <td class="tdField">
                                                <asp:TextBox ID="txtDateFrom" runat="server" CssClass="form-control ReqG1" placeholder="From Date" Width="220px"></asp:TextBox>
                                                <asp:CalendarExtender ID="Calendar1" runat="server" TargetControlID="txtDateFrom" Format="dd-MMM-yyyy"></asp:CalendarExtender>
                                            </td>
                                            <td class="tdField">
                                                <asp:TextBox ID="txtDateTo" runat="server" CssClass="form-control ReqG1" placeholder="To Date" Width="220px"></asp:TextBox>
                                                <asp:CalendarExtender ID="Calendar2" runat="server" TargetControlID="txtDateTo" Format="dd-MMM-yyyy"></asp:CalendarExtender>
                                            </td>
                                            <td class="tdLabel">
                                        ...
                                        <tr>
                                            <%--<td colspan="6">
                                                <asp:GridView ID="gvLeaveItinerary" AllowPaging="false" ShowHeaderWhenEmpty="false" CssClass="table table-bordered  table-hover" AutoGenerateColumns="False"
                                                    DataKeyNames="LeaveCategoryCode,DateFrom,DateTo,ordering" OnRowCommand="gvLeaveItinerary_RowCommand" OnRowDataBound="gvLeaveItinerary_RowDataBound" OnRowDeleting="gvLeaveItinerary_RowDeleting" runat="server">
                                                    <Columns>
                                                        <asp:BoundField DataField="LeaveCategoryCode" HeaderText="Leave Category" />
                                                        <asp:BoundField DataField="DateFrom" HeaderText="From Date" DataFormatString="{0:dd-MMM-yyyy}" />
                                                        <asp:BoundField DataField="DateTo" HeaderText="To Date" DataFormatString="{0:dd-MMM-yyyy}" />
                                            ...
                                            <td colspan="6">
                                                <asp:GridView ID="gvLeaveItinerary" AllowPaging="false" ShowHeaderWhenEmpty="false" CssClass="table table-bordered  table-hover" AutoGenerateColumns="False"
                                                    DataKeyNames="MovementItineraryID,LeaveCategoryCode,LeaveCategoryName,DateFrom,DateTo,ordering" OnRowCommand="gvLeaveItinerary_RowCommand" OnRowDataBound="gvLeaveItinerary_RowDataBound" OnRowDeleting="gvLeaveItinerary_RowDeleting" runat="server">
                                                    <Columns>
