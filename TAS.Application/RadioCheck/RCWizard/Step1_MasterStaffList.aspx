<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Step1_MasterStaffList.aspx.cs" Inherits="RadioCheck_Step1_MasterStaffList" %>
            ...
            <ContentTemplate>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">Step 1 - Staff Master List<asp:Label ID="NumberOfStaff" runat="server" Text="" ForeColor="red"></asp:Label></h4>
                    </div>
                            ...
                            <div class="dataTable_wrapper">
                                ...
                                <asp:GridView ID="GVMyRCs" Width="100%" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Gender" HeaderText="Gender" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="LocationName" HeaderText="Duty Station" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Center" />
                                        ...
                                        <asp:BoundField DataField="StaffCategory" HeaderText="Staff Category"/>
                                    </Columns>
                                </asp:GridView>
                            </div>
                        </div>
