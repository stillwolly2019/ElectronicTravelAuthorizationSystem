<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Step4_Movements.aspx.cs" Inherits="RadioCheck_Step4_Movements" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Src="~/RadioCheck/RCWizard/WizardHeader.ascx" TagPrefix="uc1" TagName="WizardHeader" %>
            ...
            <ContentTemplate>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">Step 3 - Staff Movements<asp:Label ID="NumberOfStaff" runat="server" Text="" ForeColor="red"></asp:Label></h4>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="dataTable_wrapper">
                                ...
                                <asp:GridView ID="GVMyRCs" Width="100%" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                          <asp:TemplateField HeaderText="Movement Date" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRadioCheckDate" runat="server"
                                                    Text='<%# Eval("MovementDate", "{0:dd-MMM-yyyy}") %>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:BoundField DataField="CallSign" HeaderText="Call Sign" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="PERNO" HeaderText="PER NO" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="StaffName" HeaderText="Staff Name"/>
                                        <asp:BoundField DataField="UnitDepartment" HeaderText="Unit/Department"  />
                                        <asp:BoundField DataField="MovementType" HeaderText="Movement Type" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="DepartureOffice" HeaderText="Departure Office"/>
                                    </Columns>
                                </asp:GridView>
                            </div>
                        </div>
