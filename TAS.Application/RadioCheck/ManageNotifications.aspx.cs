...
public partial class RadioCheck_ManageNotifications : AuthenticatedPageClass
{
    ...
    void FillGrid(bool SearchMode=false)
    {
        try
        {
            ...
            if (SearchMode)
            {
                R.SearchStaffMovementRequestsByDepartmentID(ref dt,txtMRNO.Text);
            }
            else
            {
                R.GetStaffMovementRequestsByDepartmentID(ref dt);
            }
    ...
    public bool Export(ReportViewer viewer, string exportType, string reportsTitle)
    {
        try
        {
            ...
            Response.AppendHeader("Content-Disposition", "attachment; filename=" + "MyMR.pdf");
            Response.Flush();
    ...
    protected void GVMRs_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "PrintMR")
        {
            ...
            viewer.ServerReport.ReportPath = System.Configuration.ConfigurationManager.AppSettings["ReportsPath"].ToString() + "/MovementRequestForm";
            ...
            Export(viewer, "PDF", "Movement Request Form");
        }
    ...
    {
        GVMRs.SelectedIndex = -1;
        txtMRNO.Text = "";
        //txtLocation.Text = "";
        //ddlStatusCode.SelectedIndex = -1;
        lblGVMRsCount.Text = "0";
        GVMRs.DataSource = null;
        GVMRs.DataBind();
    }
    ...
    protected void ClearAll()
    {
        ...
        PanelMessageDuplicateMR.Visible = false;
        lblmsgDuplicateMR.Text = "";
        PanelMessageDuplicateMRRejection.Visible = false;
        lblmsgDuplicateMRRejection.Text = "";
    ...
    protected void ibAddStaff_Click(object sender, EventArgs e)
    {
        ...
        {
            PanelMessageDuplicateMRRejection.Visible = true;
            PanelMessageDuplicateMRRejection.CssClass = "alert alert-danger alert-dismissable";
            lblmsgDuplicateMRRejection.ForeColor = Color.Red;
            lblmsgDuplicateMRRejection.Text = "Staff member is already added";
            PanelMessageDuplicateMRRejection.Focus();
            return;
        }
    ...
    protected void btnDuplicate_Click(object sender, EventArgs e)
    {
        if (gvStaffMembers.Rows.Count > 0)
        {
            ...
            foreach (var item in user)
            {
                ...
                {
                    R.DuplicateMR(ViewState["MRID"].ToString(), item.UserID);
                }
            }
            ...
            if (NamesOfUsersWithDuplicate != "")
            {
                ...
                PanelMessageDuplicateMRRejection.CssClass = "alert alert-danger alert-dismissable";
                lblmsgDuplicateMRRejection.ForeColor = Color.Red;
                lblmsgDuplicateMRRejection.Text = "TA is already created for the following staff members" + NamesOfUsersWithDuplicate;
                PanelMessageDuplicateMRRejection.Focus();
            }

            if (NamesOfUsersWithCreated != "")
            {
                PanelMessageDuplicateMR.Visible = true;
                PanelMessageDuplicateMR.CssClass = "alert alert-success alert-dismissable";
                lblmsgDuplicateMR.Text = "TA has been created successfully for the following staff members" + NamesOfUsersWithCreated;
                lblmsgDuplicateMR.ForeColor = System.Drawing.Color.Green;
            }
        }
        else
        {
            ...
            PanelMessageDuplicateMRRejection.CssClass = "alert alert-danger alert-dismissable";
            lblmsgDuplicateMRRejection.ForeColor = Color.Red;
            lblmsgDuplicateMRRejection.Text = "Press \"+ click to save\" button to add staff member to the list.";
            PanelMessageDuplicateMRRejection.Focus();
        }
    }
    #endregion
