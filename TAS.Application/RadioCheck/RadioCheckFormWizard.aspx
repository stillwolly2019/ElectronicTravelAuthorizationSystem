<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RadioCheckFormWizard.aspx.cs" Inherits="RadioCheck_RadioCheckFormWizard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanelWizard" runat="server">
        <ContentTemplate>
            <div class="row">
                <div class="col-lg-12">
                    <iframe id="IFrameStep1" scrolling="yes" style="border: none; width: 100%; height: 1250px; background-color: #fff" runat="server"></iframe>
                </div>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
