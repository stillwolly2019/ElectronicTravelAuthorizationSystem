...
public partial class RadioCheck_RadioCheckFormWizard : AuthenticatedPageClass
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                IFrameStep1.Src = "RCWizard/Step1_MasterStaffList.aspx?RCD=" + Request["RCD"].ToString();
            }
            else
            {
