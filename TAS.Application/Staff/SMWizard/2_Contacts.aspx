<%@ Page Language="C#" AutoEventWireup="true" CodeFile="2_Contacts.aspx.cs" Inherits="Staff_SMWizard_2_Contacts" %>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">Step 3 - Staff Contacts</h4>
                            </div>
                            <div class="panel-body">
                                <asp:Panel ID="pnlContent" runat="server">
                                    ...
                                    <table>
                                        <tr>
                                            <td class="tdField">
                                                <asp:DropDownList ID="ddlContactType" runat="server" DataTextField="Description" DataValueField="LookupsID" CssClass="form-control ReqG1" Width="220px" />
                                            </td>
                                            <td class="tdField">
                                                <asp:TextBox ID="txtContactDetails" runat="server" CssClass="form-control ReqG1" placeholder="E.g 0925304070" Width="220px"></asp:TextBox>
                                            </td>
                                            <td class="tdLabel">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="6">
                                                <asp:GridView ID="gvStaffContacts" AllowPaging="false" ShowHeaderWhenEmpty="false" CssClass="table table-bordered  table-hover" AutoGenerateColumns="False"
                                                    DataKeyNames="ContactID,ContactTypeCode,Description,ordering" OnRowCommand="gvStaffContacts_RowCommand" OnRowDataBound="gvStaffContacts_RowDataBound" OnRowDeleting="gvStaffContacts_RowDeleting" runat="server">
                                                    <Columns>
                                                        <asp:BoundField DataField="Description" HeaderText="Contact Type" />
                                                        <asp:BoundField DataField="ContactDetails" HeaderText="Contact Details"/>
                                                        <asp:TemplateField ShowHeader="false">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="ibEdit" ToolTip="Click to edit" CommandName="EditContact" CommandArgument='<%# Container.DisplayIndex %>' runat="server"><li class="fa fa-edit"></li> Click to edit</asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
