<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Staffing.aspx.cs" Inherits="Staff_Staffing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript">
        ...
        function openEditStaffModal() {
            ...
            //if (StaffName != '')
            //    $get("ContentPlaceHolder1_lblEditStaff").textContent = StaffName;
        ...
        <ContentTemplate>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <asp:HiddenField ID="hdnNationality" runat="server" Value="" />
                    ...
                    <asp:GridView ID="GVStaffManagement" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False"
                        ...
                        DataKeyNames="UserID,LocationID,PRISM_Number,UserName,Email,DisplayName,DepartmentID,UnitID,SubUnitID,DeptName,IsManager,IsInternationalStaff,UNID,FirstName,LastName,Country,Title,Gender">
                        <Columns>
                            ...
                            <asp:BoundField DataField="PRISM_Number" HeaderText="PERNO" />
                            <asp:BoundField DataField="UNID" HeaderText="UN ID NO" />
                            <asp:BoundField DataField="Gender" HeaderText="Gender" />
                            <asp:BoundField DataField="LocationName" HeaderText="Location" />
                            <asp:TemplateField HeaderText="Department">
                                <ItemTemplate>
                                    <asp:Label ID="lblDepartment" Text='<%# Bind("DeptName") %>' runat="server"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <%--<asp:BoundField DataField="Department" HeaderText="Department" />--%>
                            <asp:BoundField DataField="UnitName" HeaderText="Unit" />
                            <asp:BoundField DataField="SubUnitName" HeaderText="Sub Unit" />
                            <asp:BoundField DataField="MissionName" HeaderText="Mission" />
                            ...
                            <asp:TemplateField HeaderText="Is International?">
                                <ItemTemplate>
                                    <asp:LinkButton ID="ibIsInternational" CausesValidation="False" CommandName="International" runat="server" CommandArgument='<%# Container.DisplayIndex %>'></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtFirstName" CssClass="form-control  Req1" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtLastName" CssClass="form-control  Req1" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtDisplayName" CssClass="form-control  Req1" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>Personal Number (PRISM)</label>
                                            <asp:TextBox ID="txtPRISMNumber" data-toggle="tooltip" title="Required, maximum digits is 7" CssClass="form-control  Req1 ReqN" runat="server"></asp:TextBox>
                                        </div>
                                    </div>

                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>UN ID No</label>
                                            <asp:TextBox ID="txtUNIDNo" CssClass="form-control  Req1" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>Title</label>
                                            <asp:TextBox ID="txtTitle" CssClass="form-control  Req1" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>Unit</label>
                                            <asp:DropDownList ID="ddlStaffUnit" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlStaffUnit_SelectedIndexChanged" AppendDataBoundItems="True">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlStaffSubUnit" runat="server" CssClass="form-control" AppendDataBoundItems="True">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                             ...
                             <%--   <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Personal Number (PRISM)</label>
                                            <asp:TextBox ID="txtEditStaffPRISM" data-toggle="tooltip" title="Required, maximum digits is 7" CssClass="form-control  Req1 ReqN" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Gender</label>
                                            <div class="form-group">
                                                <asp:RadioButton ID="rdMale" runat="server" Text="Male" CssClass="radio-inline" GroupName="rdGender" AutoPostBack="true" />
                                                <asp:RadioButton ID="rdFemale" runat="server" Text="Female" CssClass="radio-inline" GroupName="rdGender" AutoPostBack="true" />
                                            </div>
