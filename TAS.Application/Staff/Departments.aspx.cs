...
public partial class Staff_Departments : AuthenticatedPageClass
{
    ...
    protected void GVDepartments_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "ManageUnit")
        {
            ...
            //lblDepartmentName.Text = GVDepartments.DataKeys[Convert.ToInt32(e.CommandArgument.ToString())].Values["DeptName"].ToString();
            FillUnitGrid();
        }
