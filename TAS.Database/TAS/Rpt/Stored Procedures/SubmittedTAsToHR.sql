CREATE PROCEDURE [Rpt].[SubmittedTAsToHR]
...
SELECT u.Username,u.Email,ta.TravelAuthorizationNumber, ta.TravelersName,tec.CreatedDate ,tec.Comments,tec.[Status],DepartureDate = Itinerary.FromLocationDate,ArrivalDate = Itinerary.ToLocationDate
...
WHERE ta.isDeleted = 0 AND 
      ...
      Status IN ('Submitted','Re-Submitted to Admin') 
